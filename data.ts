export const upcoming = [
  {
    ...
    title: 'CPT212 - Introduction to Python',
    subText: 'Units: 3',
    text: 'MS Enesi',
    text2: '9:00AM - 11:00AM',
    id: '1',
  },
  {
    img: require('@/assets/images/python.png'),
...
export const notice = [
  {
    ...
    title: 'Notice for Special Examinations\n' + 'semester Spring 2025',
    subText: 'By Admin',
    text: 'Today',
    text2: '2:40PM',
    id: '1',
...
export const credentials = [
  {
    title: 'Matric Number',
    value: '21H/12277256/ST-MB',
  },
  {
    title: 'Full Name',
    value: 'PCM Tablet 500',
  },
  {
    title: 'Programme',
  ...
  {
    title: 'Faculty',
    value: 'Industrial & Applied Science',
  },
  {
